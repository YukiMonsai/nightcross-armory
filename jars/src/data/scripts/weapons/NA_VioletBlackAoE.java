...
public class NA_VioletBlackAoE implements OnHitEffectPlugin {

    public static float ARC_DAMAGE = 1000f;
    public static float ARC_COUNT = 12f;
    public static float ARC_RANGE = 650f;
    public static float ARC_RANGE_FRIENDLY = 120f;
    ...
    public static float ADD_FLUX = 125f;
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        Global.getSoundPlayer().playSound("atomicdriver_impact", 1f, 0.5f, point, Misc.ZERO);
