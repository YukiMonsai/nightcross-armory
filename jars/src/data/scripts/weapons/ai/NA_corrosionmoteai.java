...
// Code shamelessly stolen from Tartiflette

public class NA_corrosionmoteai implements MissileAIPlugin, GuidedMissileAI {
    ...
    public NA_corrosionmoteai(MissileAPI missile, ShipAPI launchingShip) {
