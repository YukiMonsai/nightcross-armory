...
import data.scripts.hullmods.NA_StargazerStars;
...
public class NA_StardustSwarmLauncherEffect implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin, SwarmLaunchingWeapon {
    ...
    public NA_StardustSwarmLauncherEffect() {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        elapsed += amount;
        if (elapsed < INITIAL_SPAWN_DELAY) {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        NA_StargazerStardust sourceSwarm = NA_StargazerStardust.getSwarmFor(weapon.getShip());
        if (sourceSwarm != null) {
            NA_StargazerStardust swarm = NA_StargazerStars.createSwarmFor(leader);
...
//
//	public static NA_StargazerStardust createTestDwellerSwarmFor(ShipAPI ship) {
