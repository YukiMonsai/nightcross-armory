...
public class NA_CorrosionMoteEffect implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin, NA_StardustWeapon {
    ...
    public static final String proj_id = "na_corrosionbeambullet_shot";
    public static final String wpn_id = "na_corrosionbeambullet";
