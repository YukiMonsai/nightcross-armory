...
public class NA_NightcrossThemeSpecial extends BaseSalvageSpecial {
...
//		SYSTEM_PRELIMINARY_SURVEY,
		...
		ACTIVATE_NIGHTCROSS_OUTPOST,
		ACTIVATE_STARGAZER_STATION,
	}


	public static class NightcrossThemeSpecialData implements SalvageSpecialData {
	...
	private NightcrossThemeSpecialData data;

	public NA_NightcrossThemeSpecial() {
	}
	...
	public void init(InteractionDialogAPI dialog, Object specialData) {
		...
		data = (NightcrossThemeSpecialData) specialData;
...
//			break;
		case LOCATION_NIGHTCROSS_OUTPOST:
...
//		dialog.getOptionPanel().addOption("Continue", "continue");
	...
	public boolean shouldShowAgain() {
		return data != null && (
			data.type == SpecialType.ACTIVATE_NIGHTCROSS_OUTPOST ||
			data.type == SpecialType.ACTIVATE_STARGAZER_STATION
		);
	}
	...
	private void initSurveyParentEntity() {
		...
		String text1 = "The $shortName contains heavily-damaged, but still recoverable, records that ";
		String text1ForIntel = "While exploring $aOrAn $nameInText, your crews found " +
				"partially accessible research records that ";
