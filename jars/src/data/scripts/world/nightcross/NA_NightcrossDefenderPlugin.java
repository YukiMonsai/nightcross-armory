...
public class NA_NightcrossDefenderPlugin extends BaseGenericPlugin implements SalvageGenFromSeed.SalvageDefenderModificationPlugin {
    ...
    public int getHandlingPriority(Object params) {
        ...
        if (p.entity!=null && p.entity.getCustomEntitySpec() != null && p.entity.getCustomEntitySpec().getId().startsWith("naai_research")) {
            return 2;
        }
        return 0;
    }
