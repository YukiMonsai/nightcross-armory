...
public class StargazerStation extends SourceBasedFleetManager {

    public class StargazerEncounterGenerator implements EncounterPointProvider {
    ...
    protected transient StargazerEncounterGenerator epGen;

    public StargazerStation(SectorEntityToken source, float thresholdLY, int minFleets, int maxFleets, float respawnDelay,
    ...
    public void advance(float amount) {
        if (!addedListener) {
            ...
            epGen = new StargazerEncounterGenerator();
    ...
    protected CampaignFleetAPI spawnFleet() {
        ...
        fleet.addScript(new NA_StargazerBehavior(
