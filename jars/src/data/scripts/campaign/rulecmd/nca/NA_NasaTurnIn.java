 ...
 *
 */
public class NA_NasaTurnIn extends BaseCommandPlugin {

    public static float VALUE_MULT = 2.0f;
    public static float REP_MULT = 0.6f;
        ...
        dialog.showCargoPickerDialog("Select items to turn in", "Confirm", "Cancel", true, width, copy, new CargoPickerListener() {
            public void pickedCargo(CargoAPI cargo) {
                ...
                if (bounty > 0) {
                    ...
                    String soldTotalKey = "$itemValueSoldToNCANasaStargazer";
                    int curr = mem.getInt(soldTotalKey);
                    curr += bounty;
                    mem.set(soldTotalKey, curr);


                    soldTotalKey = "$itemValueSoldToNCANasaTotal";
                ...
                mem.set("$itemValueSoldToNCANasaJustNowStargazer", (int)bounty, 0);
                mem.set("$itemValueSoldToNCANasaJustNowTotal", (int)bounty, 0);
                FireBest.fire(null, dialog, memoryMap, "NCANasaItemsTurnedIn");
            }
