...
public class HitAndRun extends SCBaseSkillPlugin {
    ...
    public void addTooltip(SCData scData, TooltipMakerAPI tooltipMakerAPI) {
        ...
        tooltipMakerAPI.addPara("Only %s of EMP damage is counted. Damage dealt by beams is not counted, unless the damage is dealt to hull or armor.", 0f, Misc.getGrayColor(), Misc.getHighlightColor(),
                "" + (int)(100 * EMP_MULT) + "%"
    ...
    public void applyEffectsBeforeShipCreation(SCData data, MutableShipStatsAPI stats, ShipVariantAPI variant, ShipAPI.HullSize hullSize, String id) {
        ...
        if (systemSpec != null) {
            if (systemSpec.hasTag(Tags.SHIP_SYSTEM_MOVEMENT) || (NAModPlugin.system_whitelist_movement.containsKey(systemSpec.getId())
                && NAModPlugin.system_whitelist_movement.get(systemSpec.getId()) == true)) {
